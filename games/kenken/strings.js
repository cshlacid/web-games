...
(function () {
  SharedI18n.add({
    ko: {
      ...
      'kenken.badMarks': '정답이 빠진 연필 표시가 있습니다. 표시한 칸을 다시 보세요.',
      'kenken.why.cageMarks': '케이지의 셈을 맞출 수 있는 숫자만 연필로 남겼습니다.',
      'kenken.why.trialMarks': '이 칸은 {digit}일 수 없습니다 — 넣으면 어딘가에서 모순이 생깁니다.',
      ...
      'kenken.rule6': '<b>힌트</b>는 틀린 숫자를 짚어 주고, 틀린 것이 없으면 지금까지 넣은 숫자와 연필 표시로 새로 알 수 있는 것 하나를 까닭과 함께 알려 줍니다. 칸이 확정되면 숫자를 넣고, 아니면 연필 후보만 줄입니다.',
    ...
    en: {
      ...
      'kenken.badMarks': 'A pencil mark is missing the right number. Check the highlighted cell.',
      'kenken.why.cageMarks': 'Only the numbers that can make this cage work are left in pencil.',
      'kenken.why.trialMarks': 'This cell can’t be {digit} — putting it there leads to a contradiction.',
      ...
      'kenken.rule6': 'A <b>Hint</b> points out a wrong number, or if there is none, tells you one new thing that follows from your numbers and pencil marks, and why. If a cell is settled it fills the number; otherwise it only trims the pencil marks.',
    ...
    ja: {
      ...
      'kenken.badMarks': '正解が抜けた鉛筆書きがあります。示したマスを見直してください。',
      'kenken.why.cageMarks': 'ケージの計算を合わせられる数字だけを鉛筆で残しました。',
      'kenken.why.trialMarks': 'このマスは{digit}ではありません — 入れるとどこかで矛盾が出ます。',
      ...
      'kenken.rule6': '<b>ヒント</b>は間違った数字を示し、なければ今までの数字と鉛筆書きから新しくわかることをひとつ、理由と一緒に教えます。マスが確定すれば数字を入れ、そうでなければ鉛筆の候補だけを減らします。',
    ...
    'zh-CN': {
      ...
      'kenken.badMarks': '有铅笔记号漏掉了正确的数字，请看看标出的格子。',
      'kenken.why.cageMarks': '只用铅笔留下能让这个笼子算式成立的数字。',
      'kenken.why.trialMarks': '这一格不能是 {digit}——放进去会在某处产生矛盾。',
      ...
      'kenken.rule6': '<b>提示</b>会指出错误的数字；没有错误时，根据已填数字和铅笔记号告诉你一条新推论和理由。格子能确定就填数字，否则只减少铅笔候选。',
    ...
    'zh-TW': {
      ...
      'kenken.badMarks': '有鉛筆記號漏掉了正確的數字，請看看標出的格子。',
      'kenken.why.cageMarks': '只用鉛筆留下能讓這個籠子算式成立的數字。',
      'kenken.why.trialMarks': '這一格不能是 {digit}——放進去會在某處產生矛盾。',
      ...
      'kenken.rule6': '<b>提示</b>會指出錯誤的數字；沒有錯誤時，根據已填數字和鉛筆記號告訴你一條新推論和理由。格子能確定就填數字，否則只減少鉛筆候選。',
    ...
    es: {
      ...
      'kenken.badMarks': 'Una nota a lápiz no incluye el número correcto. Revisa la casilla marcada.',
      'kenken.why.cageMarks': 'Solo quedan a lápiz los números que pueden cuadrar esta jaula.',
      'kenken.why.trialMarks': 'Esta casilla no puede ser {digit}: ponerlo lleva a una contradicción.',
      ...
      'kenken.rule6': 'La <b>pista</b> señala un número incorrecto; si no hay ninguno, te dice una cosa nueva que se deduce de tus números y notas, y por qué. Si una casilla queda fija pone el número; si no, solo recorta las notas a lápiz.',
