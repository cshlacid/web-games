...
const P = typeof require === 'function' ? require('./puzzles.js') : window.KenKenPuzzles;

// 판 하나. 방금 푼 판은 건너뛴다 — 예순 판뿐이라 같은 판이 잇달아 나오면 새로 받은
// 느낌이 들지 않는다.
function pick(level, skip, random = Math.random) {
  ...
  return { id, level, code: set.list[id], ...R.parse(set.size, set.list[id]) };
}

const api = { PUZZLES: P.PUZZLES, pick };

if (typeof module !== 'undefined' && module.exports) module.exports = api;
if (typeof window !== 'undefined') window.KenKenGenerator = api;
