...
(function () {
  SharedI18n.add({
    ko: {
      ...
      'idioms.why.only': '밝힌 칸을 덮을 수 있는 성어는 이것뿐입니다. {line}',
      'idioms.why.ahead': '다른 성어로 밝힌 칸을 덮으면 덮을 길이 없는 빈 칸이 생깁니다. {line}',
    ...
    en: {
      ...
      'idioms.why.only': 'Only this idiom can cover the highlighted cell. {line}',
      'idioms.why.ahead': 'Any other idiom on the highlighted cell would leave an empty cell that nothing can cover. {line}',
    ...
    ja: {
      ...
      'idioms.why.only': '光っているマスを覆える熟語はこれだけです。{line}',
      'idioms.why.ahead': 'ほかの熟語で光っているマスを覆うと、どれでも覆えない空きマスが残ります。{line}',
    ...
    'zh-CN': {
      ...
      'idioms.why.only': '能覆盖高亮格子的成语只有这一个。{line}',
      'idioms.why.ahead': '用别的成语覆盖高亮格子，就会剩下无法覆盖的空格。{line}',
    ...
    'zh-TW': {
      ...
      'idioms.why.only': '能覆蓋高亮格子的成語只有這一個。{line}',
      'idioms.why.ahead': '用別的成語覆蓋高亮格子，就會剩下無法覆蓋的空格。{line}',
    ...
    es: {
      ...
      'idioms.why.only': 'Solo este modismo puede cubrir la casilla resaltada. {line}',
      'idioms.why.ahead': 'Cualquier otro modismo en la casilla resaltada dejaría una casilla vacía que nada puede cubrir. {line}',
