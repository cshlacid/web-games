...
(function () {
  SharedI18n.add({
    ...
    ja: {
      ...
      'idioms.rule1': '格子に韓国語の<b>四字熟語</b>が隠れています。四マスを道でつないで見つけます。',
    ...
    'zh-CN': {
      'meta.desc': '把格子里藏着的韩语四字成语连成路径，用尽每一格',
      ...
      'idioms.rule1': '格子里藏着韩语<b>四字成语</b>。把四格连成一条路径就找到一个。',
    ...
    'zh-TW': {
      'meta.desc': '把格子裡藏著的韓語四字成語連成路徑，用盡每一格',
      ...
      'idioms.rule1': '格子裡藏著韓語<b>四字成語</b>。把四格連成一條路徑就找到一個。',
