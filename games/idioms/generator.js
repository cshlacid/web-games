...
// 5×5는 다섯 칸, 6×6은 여덟 칸이 벽으로 남는다.
//
// **6×6에 여덟 개를 넣지 않는다.** 칸이 서른여섯이라 아홉 개까지 들어가 보이지만,
// 성어가 많아질수록 벽이 줄고 벽이 줄수록 다른 성어들로도 덮을 수 있는 길이 늘어
// 유일해가 드물어진다. 서른 번씩 재 보니 일곱 개는 서른 번 다 배치돼 스물둘이
// 유일해였고 판당 1밀리초였는데, 여덟 개는 열다섯 번만 배치되고 판당 242밀리초로
// 뛰었다.
const COUNT = { 4: 4, 5: 5, 6: 7 };
