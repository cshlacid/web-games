...
// 나머지는 남는 칸이 벽이 된다(5×5는 다섯, 6×6은 여덟, 7×7은 열세 칸).
//
// **칸이 남는 만큼 다 채우지 않는다.** 성어가 많아질수록 벽이 줄고, 벽이 줄수록
// 다른 성어들로도 덮을 수 있는 길이 늘어 유일해가 드물어진다. 배치 자체도 급격히
// 어려워진다. 스무 번씩 재 본 값이다.
//   6×6  일곱 개 → 서른 번 다 배치·판당 1밀리초 / 여덟 개 → 열다섯 번·242밀리초
//   7×7  아홉 개 → 스무 번 다 배치·판당 1밀리초 / 열한 개 → 네 번·694밀리초
// 7×7에 열 개까지는 되지만 끝까지 재 보니 열에 하나가 1.6초를 넘겼다(일본어·중국어
// 사전). 아홉 개는 90%가 2밀리초 안이다.
const COUNT = { 4: 4, 5: 5, 6: 7, 7: 9 };
