...
(function () {
  SharedI18n.add({
    ko: {
      ...
      'road.rule16': '<b>우회전은 신호를 기다리지 않습니다.</b> 빨간 불에도 모퉁이를 돌아 나갑니다. 다만 같은 차로로 나갈 차가 녹색을 받고 오면 그 차를 먼저 보내고, 횡단보도에 사람이 있으면 그 앞에 섭니다.',
      'road.money': '예산',
      'road.flip': '방향 바꾸기',
      'road.addLane': '차로 늘리기',
    ...
    en: {
      ...
      'road.rule16': '<b>A right turn does not wait for the light.</b> It rounds the corner even on red. It does give way to anything coming on green that is headed for the same lane, and it stops for anyone on the crosswalk.',
      'road.money': 'Budget',
      'road.flip': 'Flip way',
    ...
    ja: {
      ...
      'road.rule16': '<b>右折は信号を待ちません。</b>赤でも角を曲がって出ていきます。ただし同じ車線へ出ようとする青信号の車には道を譲り、横断歩道に人がいればその手前で止まります。',
      'road.money': '予算',
      'road.flip': '向きを変える',
      'road.addLane': '車線を増やす',
    ...
    'zh-CN': {
      ...
      'road.rule16': '<b>右转不等信号。</b>红灯也能拐过路口。不过要让绿灯放行、要并入同一车道的车先走，人行横道上有人时则停在线前。',
      'road.money': '预算',
      'road.flip': '改变方向',
      'road.addLane': '增加车道',
    ...
    'zh-TW': {
      ...
      'road.rule16': '<b>右轉不等號誌。</b>紅燈也能轉過路口。不過要讓綠燈放行、要併入同一車道的車先走，行人穿越道上有人時則停在線前。',
      'road.money': '預算',
      'road.flip': '改變方向',
      'road.addLane': '增加車道',
    ...
    es: {
      ...
      'road.rule16': '<b>Girar a la derecha no espera al semáforo.</b> Toma la esquina incluso en rojo. Eso sí, cede el paso a quien viene en verde hacia el mismo carril y se detiene si hay alguien en el paso de peatones.',
